...
def get_parser():
    ...
    parser.add_argument(
        ...
        " If you want to correct segmentation only, omit 'FILES_LABEL' in the list. Below is an example .yml file:\n"
        + dedent(
            """
            FILES_SEG:
        ...
        if files is not None:
            for file in files:
                ...
                fname_label = os.path.join(
                    path_out_deriv, subject, contrast, utils.add_suffix(file, get_suffix(task, '-disc-manual')))
